    ...
    registerBlockType('lrob-carte/menu-display', {
        edit: function (props) {
            ...
            const {
                displayMode = 'all',
                selectedCategory = 0,
                defaultCategorySelection = 'first',
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        ...
                        { title: __('Display', 'lrob-la-carte'), initialOpen: true },
                                             ...
                                             displayMode === 'all' &&
                                             wp.element.createElement(SelectControl, {
                                                 label: __('Default Category Selection', 'lrob-la-carte'),
                                                                      value: defaultCategorySelection,
                                                                      options: [
                                                                          { label: __('First category', 'lrob-la-carte'), value: 'first' },
                                                                      { label: __('None (show all at once)', 'lrob-la-carte'), value: 'none' }
                                                                      ],
                                                                      onChange: value => setAttributes({ defaultCategorySelection: value })
                                             }),
                                             displayMode === 'all' &&
                                             wp.element.createElement(SelectControl, {
